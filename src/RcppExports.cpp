...
RcppExport SEXP _beachball_calc_silhouette(SEXP, SEXP);
RcppExport SEXP _beachball_check_medoids(SEXP, SEXP, SEXP);
RcppExport SEXP _beachball_check_NaN_Inf(SEXP);
RcppExport SEXP _beachball_cluster_indices(SEXP);
RcppExport SEXP _beachball_duplicated_flag(SEXP);
RcppExport SEXP _beachball_kmeans_pp_dist(SEXP, SEXP);
RcppExport SEXP _beachball_kmeans_pp_init(SEXP, SEXP, SEXP);
RcppExport SEXP _beachball_MinMat(SEXP);
RcppExport SEXP _beachball_norm_fuzzy(SEXP, SEXP);
RcppExport SEXP _beachball_quantile_init_rcpp(SEXP, SEXP, SEXP);
RcppExport SEXP _beachball_quantile_value(SEXP, SEXP);
RcppExport SEXP _beachball_sample_vec(SEXP, SEXP, SEXP, SEXP);
RcppExport SEXP _beachball_SCALE(SEXP, SEXP, SEXP);
RcppExport SEXP _beachball_set_seed(SEXP);
RcppExport SEXP _beachball_squared_norm(SEXP);
RcppExport SEXP _beachball_validate_centroids(SEXP, SEXP);
RcppExport SEXP _beachball_WCSS(SEXP, SEXP);
