...
## Running with multiple values of $k$
...
Here, we apply `mbkmeans` with $k$ from 4 to 15 and select the number of clusters using the elbow method (i.e., the value that corresponds to the point of inflection on the curve).
...
From the plot, it seems that `k=9` could be a reasonable value.
