...
#4 predict_mini_batch


The mbkmeans function can calculate the centroids and provide the clusters results based on data, while predict_mini_batch function just gives clusters results with data and centroids as input.

```{r}
#pre_res<-predict_mini_batch(t(sce1000),CENTROIDS = res$centroids)
