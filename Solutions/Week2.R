...
feature<- DelayedArray::rowSums(counts(data2)>0)>0
...
sizeFactors(dataclean2) <- lib.sizes
#nor<-normalize(dataclean2) ## this does not work... bug?
#assayNames(nor)
...
saveRDS(dataclean2, file="filtered_data.rds")
