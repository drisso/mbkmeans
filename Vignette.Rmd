...
system.time(mbk_res<-mbkmeans(data_sce, reduceMethod = "none", clusters = 3, batch_size = 100, init_fraction = .1, max_iters = 10))
...
system.time(mbk_res<-mbkmeans(data_sce, reduceMethod = "none", clusters = 3, batch_size = 100, init_fraction = .1, max_iters = 10,initializer = "random"))
```
