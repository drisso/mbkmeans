...
htmlwidgets::saveWidget(sub_mini, "sub_mini.html")
browseURL("sub_mini.html")
```
...
htmlwidgets::saveWidget(sub_mbk, "sub_mbk.html")
browseURL("sub_mbk.html")
```
...
htmlwidgets::saveWidget(total_mini, "total_mini.html")
browseURL("total_mini.html")
```
...
htmlwidgets::saveWidget(total_mbk, "total_mbk.html")
browseURL("total_mbk.html")
```
...
```{r ARI_function}
ARI_cal<-function(data,cluster){
    
    ari<-numeric(100)
    
    for(i in 1:100){
        
        mat1<-mini_batch(data,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .1,initializer = "random",wcss_show=TRUE,seed = NULL)
        
       ari[i]<-adjustedRandIndex(cluster,mat1$Clusters)
    }
    
    ari_final<-mean(ari[i])
...
out_seed<-mini_batch(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .1,initializer = "random",wcss_show=TRUE,seed = NULL)

in_seed<-mini_batch(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .1,initializer = "random",wcss_show=TRUE)

out_1_ari<-adjustedRandIndex(out_seed$Clusters,iris$Species)
in_1_ari<-adjustedRandIndex(in_seed$Clusters,iris$Species)

out_ari<-ARI_cal(subset_iris,iris$Species)
in_ari<-ARI_cal(subset_iris,iris$Species)
...
#mini_batch_matrix
time3<-system.time(mini_km_matrix<-mini_batch(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .1,initializer = "random",wcss_show=TRUE))[3]


#mini_batch_hdf5
time4<-system.time(mini_km_hdf5<-mini_batch(subset_iris_hdf5,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .1,initializer = "random",wcss_show=TRUE))[3]
...
#mini_batch_matrix
time6<-system.time(mini_kmplus_matrix<-mini_batch(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .1,initializer = "kmeans++",wcss_show=TRUE))[3]

#mini_batch_hdf5
time7<-system.time(mini_kmplus_hdf5<-mini_batch(subset_iris_hdf5,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .1,initializer = "kmeans++",wcss_show=TRUE))[3]
...
mini_init_3<-mini_batch(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .3,initializer = "random")

mini_init_4<-mini_batch(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .4,initializer = "random")

mini_init_5<-mini_batch(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .5,initializer = "random")
...
mini_hdf5_init_3<-mini_batch(subset_iris_hdf5,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .3,initializer = "random")

mini_hdf5_init_4<-mini_batch(subset_iris_hdf5,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .4,initializer = "random")

mini_hdf5_init_5<-mini_batch(subset_iris_hdf5,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .5,initializer = "random")
...
cluR_km<-MiniBatchKmeans(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .3,initializer = "random")
clu_init_3<-predict_MBatchKMeans(subset_iris,CENTROIDS = cluR_km$centroids)

cluR_km<-MiniBatchKmeans(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .4,initializer = "random")
clu_init_4<-predict_MBatchKMeans(subset_iris,CENTROIDS = cluR_km$centroids)

cluR_km<-MiniBatchKmeans(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .5,initializer = "random")
clu_init_5<-predict_MBatchKMeans(subset_iris,CENTROIDS = cluR_km$centroids)



mini_init_1_ARI<-ARI_cal(iris$Species,mini_init_1$Clusters)
mini_init_2_ARI<-ARI_cal(iris$Species,mini_init_2$Clusters)
mini_init_3_ARI<-ARI_cal(iris$Species,mini_init_3$Clusters)
mini_init_4_ARI<-ARI_cal(iris$Species,mini_init_4$Clusters)
mini_init_5_ARI<-ARI_cal(iris$Species,mini_init_5$Clusters)

mini_hdf5_init_1_ARI<-ARI_cal(iris$Species,mini_hdf5_init_1$Clusters)
mini_hdf5_init_2_ARI<-ARI_cal(iris$Species,mini_hdf5_init_2$Clusters)
mini_hdf5_init_3_ARI<-ARI_cal(iris$Species,mini_hdf5_init_3$Clusters)
mini_hdf5_init_4_ARI<-ARI_cal(iris$Species,mini_hdf5_init_4$Clusters)
mini_hdf5_init_5_ARI<-ARI_cal(iris$Species,mini_hdf5_init_5$Clusters)

clu_init_1_ARI<-ARI_cal(iris$Species,clu_init_1)
clu_init_2_ARI<-ARI_cal(iris$Species,clu_init_2)
clu_init_3_ARI<-ARI_cal(iris$Species,clu_init_3)
clu_init_4_ARI<-ARI_cal(iris$Species,clu_init_4)
clu_init_5_ARI<-ARI_cal(iris$Species,clu_init_5)

table_init_km<-cbind(mini_init_1_ARI,mini_init_2_ARI,mini_init_3_ARI,mini_init_4_ARI,mini_init_5_ARI,mini_hdf5_init_1_ARI,mini_hdf5_init_2_ARI,mini_hdf5_init_3_ARI,mini_hdf5_init_4_ARI,mini_hdf5_init_5_ARI,clu_init_1_ARI,clu_init_2_ARI,clu_init_3_ARI,clu_init_4_ARI,clu_init_5_ARI)
table_init_km
```

```{r init_fraction test-2}
#kmeans++
...
mini_init_3_plus<-mini_batch(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .3,initializer = "kmeans++")

mini_init_4_plus<-mini_batch(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .4,initializer = "kmeans++")

mini_init_5_plus<-mini_batch(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .5,initializer = "kmeans++")
...
mini_hdf5_init_3_plus<-mini_batch(subset_iris_hdf5,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .3,initializer = "kmeans++")

mini_hdf5_init_4_plus<-mini_batch(subset_iris_hdf5,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .4,initializer = "kmeans++")

mini_hdf5_init_5_plus<-mini_batch(subset_iris_hdf5,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .5,initializer = "kmeans++")
...
cluR_km<-MiniBatchKmeans(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .3,initializer = "kmeans++")
clu_init_3_plus<-predict_MBatchKMeans(subset_iris,CENTROIDS = cluR_km$centroids)


cluR_km<-MiniBatchKmeans(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .4,initializer = "kmeans++")
clu_init_4_plus<-predict_MBatchKMeans(subset_iris,CENTROIDS = cluR_km$centroids)


cluR_km<-MiniBatchKmeans(subset_iris,clusters = 3,batch_size = 10, num_init = 10,max_iters = 100,init_fraction = .5,initializer = "kmeans++")
clu_init_5_plus<-predict_MBatchKMeans(subset_iris,CENTROIDS = cluR_km$centroids)



mini_init_1_plus_ARI<-ARI_cal(iris$Species,mini_init_1_plus$Clusters)
mini_init_2_plus_ARI<-ARI_cal(iris$Species,mini_init_2_plus$Clusters)
mini_init_3_plus_ARI<-ARI_cal(iris$Species,mini_init_3_plus$Clusters)
mini_init_4_plus_ARI<-ARI_cal(iris$Species,mini_init_4_plus$Clusters)
mini_init_5_plus_ARI<-ARI_cal(iris$Species,mini_init_5_plus$Clusters)

mini_hdf5_init_1_plus_ARI<-ARI_cal(iris$Species,mini_hdf5_init_1_plus$Clusters)
mini_hdf5_init_2_plus_ARI<-ARI_cal(iris$Species,mini_hdf5_init_2_plus$Clusters)
mini_hdf5_init_3_plus_ARI<-ARI_cal(iris$Species,mini_hdf5_init_3_plus$Clusters)
mini_hdf5_init_4_plus_ARI<-ARI_cal(iris$Species,mini_hdf5_init_4_plus$Clusters)
mini_hdf5_init_5_plus_ARI<-ARI_cal(iris$Species,mini_hdf5_init_5_plus$Clusters)

clu_init_1_plus_ARI<-ARI_cal(iris$Species,clu_init_1_plus)
clu_init_2_plus_ARI<-ARI_cal(iris$Species,clu_init_2_plus)
clu_init_3_plus_ARI<-ARI_cal(iris$Species,clu_init_3_plus)
clu_init_4_plus_ARI<-ARI_cal(iris$Species,clu_init_4_plus)
clu_init_5_plus_ARI<-ARI_cal(iris$Species,clu_init_5_plus)

table_init_plus<-cbind(mini_init_1_plus_ARI,mini_init_2_plus_ARI,mini_init_3_plus_ARI,mini_init_4_plus_ARI,mini_init_5_plus_ARI,mini_hdf5_init_1_plus_ARI,mini_hdf5_init_2_plus_ARI,mini_hdf5_init_3_plus_ARI,mini_hdf5_init_4_plus_ARI,mini_hdf5_init_5_plus_ARI,clu_init_1_plus_ARI,clu_init_2_plus_ARI,clu_init_3_plus_ARI,clu_init_4_plus_ARI,clu_init_5_plus_ARI)
table_init_plus
```
...
ARI10<-ARI_cal(iris$Species,bat10$Clusters)
ARI15<-ARI_cal(iris$Species,bat15$Clusters)
ARI20<-ARI_cal(iris$Species,bat20$Clusters)
ARI25<-ARI_cal(iris$Species,bat25$Clusters)
...
#AIR vs TIME
#random
ARI1<-ARI_cal(iris$Species,km_matrix$cluster)
ARI2<-ARI_cal(iris$Species,km_matrix_2$cluster)
ARI3<-ARI_cal(iris$Species,mini_km_matrix$Clusters)
ARI4<-ARI_cal(iris$Species,mini_km_hdf5$Clusters)
ARI5<-ARI_cal(iris$Species,cluR_km_matrix)
#kmeans++
ARI6<-ARI_cal(iris$Species,mini_kmplus_matrix$Clusters)
ARI7<-ARI_cal(iris$Species,mini_kmplus_hdf5$Clusters)
ARI8<-ARI_cal(iris$Species,cluR_kmplus_matrix)
ARI9<-ARI_cal(iris$Species,kmeans_plus$clusters)
...
ari_total$Time<-as.numeric(ari_total$Time)
...
#WCSS vs TIME
km_matrix_wcss<-cluster_wcss(dat=subset_iris,centro =km_matrix$centers,label =km_matrix$cluster )
km_matrix_2_wcss<-cluster_wcss(dat=subset_iris,centro =km_matrix_2$centers,label = km_matrix_2$cluster)

mini_km_matrix_wcss<-cluster_wcss(dat=subset_iris,centro =mini_km_matrix$centroids,label = mini_km_matrix$Clusters)
mini_km_hdf5_wcss<-cluster_wcss(dat=subset_iris,centro =mini_km_hdf5$centroids,label=mini_km_hdf5$Clusters)
cluR_km_wcss<-cluster_wcss(dat=subset_iris,centro =cluR_km$centroids,label = cluR_km_matrix)
mini_kmplus_matrix_wcss<-cluster_wcss(dat=subset_iris,centro =mini_kmplus_matrix$centroids,label = mini_kmplus_matrix$Clusters)
mini_kmplus_hdf5_wcss<-cluster_wcss(dat=subset_iris,centro =mini_kmplus_hdf5$centroids,label = mini_kmplus_hdf5$Clusters)
cluR_kmplus_wcss<-cluster_wcss(dat=subset_iris,centro =cluR_kmplus$centroids,label = cluR_kmplus_matrix)
kmeans_plus_wcss<-cluster_wcss(dat=subset_iris,centro =kmeans_plus$centroids,label =kmeans_plus$clusters )
...
total_km_WCSS_2<-rbind(km_matrix_wcss,km_matrix_2_wcss,mini_km_matrix_wcss,mini_km_hdf5_wcss,cluR_km_wcss,mini_kmplus_matrix_wcss,mini_kmplus_hdf5_wcss,cluR_kmplus_wcss,kmeans_plus_wcss)
...
wcss_km$Time<-as.numeric(wcss_km$Time)
